...
import { ApiConfigStatus } from '../generated';
...
export class ApiConfigurationRepository {
     ...
     * 更新API调用统计
     */
    static async updateCallStats(id, success, errorMessage) {
        try {
            const updateData = {
     ...
     * 获取API调用日志
     */
    static async getCallLogs(configId, options) {
        try {
    ...
    static async getStats() {
        try {
            const [total, active, inactive, error, callStats] = await Promise.all([
