...
export const NewsCard: React.FC<NewsCardProps> = ({
  ...
  if (viewMode === 'list') {
    return (
      <div 
        className={`bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer ${className}`}
  ...
  return (
    <div 
      className={`bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer h-full ${className}`}
      onClick={handleCardClick}
    >
      {/* 缩略图 */}
      {content.imageUrl && (
