...
export const SearchAndFilter: React.FC<SearchAndFilterProps> = ({
  ...
  const [tempFilters, setTempFilters] = useState<ContentFilter>(filters);
  ...
  const handleResetFilters = () => {
    const resetFilters: ContentFilter = {
      page: 1,
  ...
  const updateTempFilter = (key: keyof ContentFilter, value: any) => {
    setTempFilters(prev => ({
      ...prev,
      [key]: value || undefined,
    }));
  ...
  const activeFiltersCount = Object.values(filters).filter(value => 
    ...
    value !== 'PUBLISHED' && value !== 1 && value !== 20
  ).length;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateTempFilter('sourceId', e.target.value)}
            ...
            <div>
              ...
              <div className="flex gap-1">
                <select
                  value={tempFilters.sortBy || 'publishedAt'}
                ...
                <button
                  type="button"
                  onClick={() => updateTempFilter('sortOrder', tempFilters.sortOrder === 'desc' ? 'asc' : 'desc')}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateTempFilter('dateFrom', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateTempFilter('dateTo', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            </div>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          {filters.sourceId && (
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-green-100 text-green-800">
              ...
              <button
                onClick={() => onFiltersChange({ ...filters, sourceId: undefined })}
