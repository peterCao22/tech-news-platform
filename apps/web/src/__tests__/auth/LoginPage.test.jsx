...
jest.mock('@/components/ui/button', () => ({
    Button: ({ children, onClick, disabled, loading, ...props }) => (<button onClick={onClick} disabled={disabled || loading} data-testid="button" {...props}>
      {loading ? 'Loading...' : children}
    </button>),
}));
jest.mock('@/components/ui/input', () => ({
    Input: ({ error, ...props }) => (<input data-testid={props.name || 'input'} className={error ? 'error' : ''} {...props}/>),
}));
