      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            {isAuthenticated && user ? (<div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-3">
                {!isAuthenticated ? (<Link href="/auth/login">
                  ...
                  </Link>) : (<Button onClick={() => router.back()} variant="outline" className="w-full">
            ...
            <div className="border-t pt-4">
              <p className="text-sm text-gray-600 text-center">
                如果您认为这是一个错误，请{' '}
                <Link href="/support" className="text-primary-600 hover:text-primary-500 inline-flex items-center gap-1">
