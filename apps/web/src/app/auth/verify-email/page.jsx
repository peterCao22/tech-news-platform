          ...
          <CardContent className="space-y-4">
            {verificationStatus === 'pending' && !token && (<>
                ...
                <div className="flex flex-col space-y-3">
                  <Button onClick={resendVerificationEmail} disabled={isResending || countdown > 0} loading={isResending} variant="outline" className="w-full">
                    {countdown > 0
                ? `重新发送 (${countdown}s)`
                : isResending
                    ? '发送中...'
            ...
            {verificationStatus === 'error' && (<div className="flex flex-col space-y-3">
                <Button onClick={resendVerificationEmail} disabled={isResending || countdown > 0} loading={isResending} className="w-full">
                  {countdown > 0
                ? `重新发送 (${countdown}s)`
                : isResending
                    ? '发送中...'
            ...
            {verificationStatus === 'success' && (<div className="text-center">
