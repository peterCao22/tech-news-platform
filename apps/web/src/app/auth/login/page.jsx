            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <Input {...register('email')} type="email" autoComplete="email" className="pl-10" placeholder="your@email.com" error={!!errors.email}/>
                </div>
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <Input {...register('password')} type={showPassword ? 'text' : 'password'} autoComplete="current-password" className="pl-10 pr-10" placeholder="输入密码" error={!!errors.password}/>
