            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <Input {...register('password')} type={showPassword ? 'text' : 'password'} className="pl-10 pr-10" placeholder="输入新密码" error={!!errors.password}/>
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <Input {...register('confirmPassword')} type={showConfirmPassword ? 'text' : 'password'} className="pl-10 pr-10" placeholder="再次输入新密码" error={!!errors.confirmPassword}/>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                ...
                <ul className="text-sm text-blue-700 space-y-1">
                  <li className="flex items-center gap-2">
                    <div className={`w-2 h-2 rounded-full ${watchedPassword && watchedPassword.length >= 8 ? 'bg-green-500' : 'bg-gray-300'}`}/>
                    至少8个字符
                  </li>
                  <li className="flex items-center gap-2">
                  ...
                  <li className="flex items-center gap-2">
                    <div className={`w-2 h-2 rounded-full ${watchedPassword && /\d/.test(watchedPassword) ? 'bg-green-500' : 'bg-gray-300'}`}/>
                    包含数字
                  </li>
                </ul>
              </div>
