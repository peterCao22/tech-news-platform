...
export default function SourcesPage() {
    ...
    // 手动抓取RSS源
    const handleFetchSource = async (id, name) => {
        try {
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3">
              ...
              <Button onClick={handleFetchAllSources} variant="outline">
          ...
          <Card>
            ...
            <CardContent>
              {sources.length === 0 ? (<div className="text-center py-12">
                  ...
                  {sources.map((source) => (<div key={source.id} className="border rounded-lg p-4 hover:bg-gray-50">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          {source.url && (<div className="flex items-center gap-2 mb-2">
                          ...
                          {source.lastError && (<div className="mt-2 p-2 bg-red-50 border border-red-200 rounded text-sm text-red-700">
                              <strong>最后错误:</strong> {source.lastError}
                            </div>)}
                        </div>
                        
                        <div className="flex items-center gap-2 ml-4">
                          <Button size="sm" variant="outline" onClick={() => handleFetchSource(source.id, source.name)}>
                            <RefreshCw className="h-4 w-4 mr-1"/>
                            抓取
                          </Button>
                          <Button size="sm" variant="outline" onClick={() => router.push(`/sources/${source.id}/edit`)}>
                            <Settings className="h-4 w-4 mr-1"/>
                            编辑
                          </Button>
                          <Button size="sm" variant="outline" onClick={() => handleDeleteSource(source.id, source.name)} className="text-red-600 hover:text-red-700 hover:bg-red-50">
