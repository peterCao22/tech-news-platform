          ...
          <Card>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select value={formData.type} onChange={(e) => handleInputChange('type', e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            category: e.target.value
                ...
                <div className="flex justify-end gap-3 pt-4">
                  ...
                  <Button type="submit" disabled={creating || (formData.type === 'RSS' && validation && !validation.valid)} loading={creating}>
                    {creating ? '创建中...' : '创建RSS源'}
                  </Button>
                </div>
              </form>
