...
describe('认证API测试', () => {
    ...
    describe('POST /api/auth/login', () => {
        it('应该成功登录有效用户', async () => {
            ...
            UserRepository.validatePassword.mockResolvedValue(mockUser);
        ...
        it('应该拒绝被暂停的用户', async () => {
            ...
            UserRepository.validatePassword.mockResolvedValue(suspendedUser);
            const response = await request(app)
                .post('/api/auth/login')
                .send({
                email: 'test@example.com',
...
export const generateTestJWT = (userId) => {
