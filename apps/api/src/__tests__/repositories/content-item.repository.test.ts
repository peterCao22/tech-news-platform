...
import { ContentItemRepository, CreateContentItemData, prisma, ContentStatus, ContentType } from '@tech-news-platform/database';
...
describe('ContentItemRepository', () => {
  ...
  describe('create', () => {
    const mockContentData: CreateContentItemData = {
      title: '测试新闻标题',
      description: '测试新闻描述',
      content: '测试新闻内容',
      sourceId: 'source-123',
