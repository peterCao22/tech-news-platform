...
const mockContentRepository = {
  ...
  updateStatus: jest.fn() as jest.MockedFunction<any>,
  incrementViewCount: jest.fn() as jest.MockedFunction<any>,
  incrementShareCount: jest.fn() as jest.MockedFunction<any>,
  checkDuplication: jest.fn() as jest.MockedFunction<any>,
  getStatistics: jest.fn() as jest.MockedFunction<any>,
...
const mockTagRepository = {
  ...
  create: jest.fn() as jest.MockedFunction<any>,
  incrementUsage: jest.fn() as jest.MockedFunction<any>,
  decrementUsage: jest.fn() as jest.MockedFunction<any>,
};

const mockContentTagRepository = {
  addTagToContent: jest.fn() as jest.MockedFunction<any>,
  removeTagFromContent: jest.fn() as jest.MockedFunction<any>,
};
...
describe('ContentItemService', () => {
  ...
  describe('getContent', () => {
    ...
    it('应该返回内容列表', async () => {
      mockContentRepository.findMany.mockResolvedValue(mockContentList as any);
  ...
  describe('createContent', () => {
    ...
    it('应该成功创建内容', async () => {
      mockContentRepository.exists.mockResolvedValue(true as any); // 来源存在
      mockContentRepository.create.mockResolvedValue(mockCreatedContent as any);
    ...
    it('当来源不存在时应该抛出错误', async () => {
      mockContentRepository.exists.mockResolvedValue(false as any);
  ...
  describe('deleteContent', () => {
    it('应该成功删除内容', async () => {
      mockContentRepository.delete.mockResolvedValue(undefined as any);
  ...
  describe('updateContentStatus', () => {
    it('应该批量更新内容状态', async () => {
      ...
      mockContentRepository.updateStatus.mockResolvedValue(undefined as any);
  ...
  describe('addContentTags', () => {
    ...
    it('应该为内容添加现有标签', async () => {
      ...
      mockContentRepository.findById.mockResolvedValueOnce(mockContent as any);
      mockContentTagRepository.addTagToContent.mockResolvedValue({} as any);
      mockTagRepository.incrementUsage.mockResolvedValue(undefined as any);
      mockContentRepository.findById.mockResolvedValueOnce(mockUpdatedContent as any);
    ...
    it('应该创建新标签并添加到内容', async () => {
      ...
      mockContentRepository.findById.mockResolvedValueOnce(mockContent as any);
      mockTagRepository.findByName.mockResolvedValue(null as any); // 标签不存在
      mockTagRepository.create.mockResolvedValue(mockTag as any);
      mockContentTagRepository.addTagToContent.mockResolvedValue({} as any);
      mockTagRepository.incrementUsage.mockResolvedValue(undefined as any);
      mockContentRepository.findById.mockResolvedValueOnce(mockUpdatedContent as any);
    ...
    it('当内容不存在时应该抛出错误', async () => {
      mockContentRepository.findById.mockResolvedValue(null as any);
  ...
  describe('removeContentTags', () => {
    ...
    it('应该移除内容标签', async () => {
      ...
      mockContentRepository.findById.mockResolvedValue(mockContent as any);
      mockContentTagRepository.removeTagFromContent.mockResolvedValue(undefined as any);
      mockTagRepository.decrementUsage.mockResolvedValue(undefined as any);
  ...
  describe('checkDuplication', () => {
    ...
    it('应该检查内容重复', async () => {
      mockContentRepository.checkDuplication.mockResolvedValue(mockDuplicationResult as any);

      const result = await service.checkDuplication('测试标题', '测试内容', 'https://example.com');

      expect(result).toEqual(mockDuplicationResult);
      expect(mockContentRepository.checkDuplication).toHaveBeenCalledWith(
        '测试标题',
        '测试内容',
        'https://example.com'
      );
  ...
  describe('incrementViewCount', () => {
    it('应该增加浏览次数', async () => {
      mockContentRepository.incrementViewCount.mockResolvedValue(undefined as any);
  ...
  describe('incrementShareCount', () => {
    it('应该增加分享次数', async () => {
      mockContentRepository.incrementShareCount.mockResolvedValue(undefined as any);
  ...
  describe('getStatistics', () => {
    ...
    it('应该返回统计信息', async () => {
      mockContentRepository.getStatistics.mockResolvedValue(mockStats as any);
