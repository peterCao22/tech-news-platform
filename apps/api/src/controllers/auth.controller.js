// 科技新闻聚合平台 - 认证控制器
// 处理所有认证相关的业务逻辑
import { UserRepository, PasswordResetRepository } from '@tech-news-platform/database';
...
export class AuthController {
    ...
    static async changePassword(req, res) {
        try {
            ...
            const isCurrentPasswordValid = await UserRepository.validatePassword(user.email, currentPassword);
