...
const router = Router();
// 用户注册
router.post('/register', authRateLimit, sanitizeInput(ValidationRules.userRegistration), [
    body('email')
        .isEmail()
        .normalizeEmail()
...
// 用户登录
router.post('/login', authRateLimit, sanitizeInput(ValidationRules.userLogin), [
    body('email')
        .isEmail()
        .normalizeEmail()
        .withMessage('请输入有效的邮箱地址'),
...
// 忘记密码
router.post('/forgot-password', passwordResetRateLimit, sanitizeInput(ValidationRules.passwordReset), [
    body('email')
        .isEmail()
        .normalizeEmail()
        .withMessage('请输入有效的邮箱地址'),
