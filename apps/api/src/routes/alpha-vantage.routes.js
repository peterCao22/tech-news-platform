 ...
 */
router.post('/fetch', authenticate, authorize(['admin', 'editor']), async (req, res) => {
    try {
 ...
 */
router.get('/tech-news', authenticate, async (req, res) => {
    try {
 ...
 */
router.get('/ai-news', authenticate, async (req, res) => {
    try {
        const limit = parseInt(req.query.limit) || 10;
 ...
 */
router.get('/company-news/:ticker', authenticate, async (req, res) => {
    try {
